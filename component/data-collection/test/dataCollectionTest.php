<?php
    ...
    //test real API data transformation
    $expectedWinlose = Array("Win","Lose");
    $msg = transformDataTest($testAPI[0], $testAPI[1],$expectedWinlose);
    consoleLog($msg);
    ...
    function transformDataTest($gameTest,$athletesTest,$expectedWinlose){
        ...
        $mappedData = $dataCollection->transformData($gameTest, $athletesTest);
        $testWinlose=array();
